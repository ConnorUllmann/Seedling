package net.flashpunk
{
	...
	public class Entity extends Tweener
	{
		 ...
		 */
		public function onScreen(n:int = 0):Boolean
		{
			if (x - originX + width < FP.camera.x - n || y - originY + height < FP.camera.y - n || x - originX > FP.camera.x + FP.screen.width + n || y - originY > FP.camera.y + FP.screen.height + n)
			{
				return false;
			}
			return true;
